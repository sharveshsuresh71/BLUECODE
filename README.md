<p align="center">
  <img src="build/logo-text-squared.svg" alt="BLUECODE" height="76">
</p>
...
<p align="center">
  ...
  <img src="https://img.shields.io/github/license/johannesjo/bluecode" alt="License">
</p>
...
<p align="center">
  <img src="screens/longer-video.gif" alt="BLUECODE demo" width="800">
</p>
...
When you create a task, BLUECODE:
...
- **Existing worktree import** — bring already-created worktrees into BLUECODE
- **Sandboxing with project-specific Dockerfiles** — drop a `.bluecode/Dockerfile` into the project and tasks run inside it
...
1. **Download** the latest release for your platform from the [releases page](https://github.com/johannesjo/bluecode/releases/latest):
   - **macOS** — `.dmg` (universal)
...
3. **Open BLUECODE**, point it at a git repo, and start dispatching tasks.
...
```sh
git clone https://github.com/johannesjo/bluecode.git
cd bluecode
npm install
npm run dev
```
...
If BLUECODE saves you time, consider giving it a [star on GitHub](https://github.com/johannesjo/bluecode). It helps others find the project.
